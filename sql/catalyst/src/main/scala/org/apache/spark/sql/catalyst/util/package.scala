...
package object util extends Logging {
  ...
  implicit class MetadataColumnHelper(attr: Attribute) {
    ...
    def isHiddenFromResolver: Boolean = attr.metadata.contains(ALIAS_HIDDEN_FROM_RESOLVER) &&
      attr.metadata.getBoolean(ALIAS_HIDDEN_FROM_RESOLVER)
  ...
  val ALIAS_HIDDEN_FROM_RESOLVER = "__resolverHiddenAlias"

  val AUTO_GENERATED_ALIAS = "__autoGeneratedAlias"

  val INTERNAL_METADATA_KEYS = Seq(
    ALIAS_HIDDEN_FROM_RESOLVER,
